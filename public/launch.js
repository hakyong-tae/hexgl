...
(function() {
  var $, a, courses, defaultControls, getWebGL, hasWebGL, init, s, u, _fn, _i, _len;

  // Course list: [menu label, track object name, difficulty]
  ...
  init = function(controlType, quality, hud, godmode, track, difficulty) {
    ...
    hexGL = new bkcore.hexgl.HexGL({
      ...
      godmode: godmode,
      track: track == null ? 'Cityscape' : track
    });
    window.hexGL = hexGL;
